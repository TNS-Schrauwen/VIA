...
| **Step 7: (Optional) Variant Identification Application (VIA)**   | This step |
...
### Installation
```sh
docker build --platform linux/amd64 -t via:v2.2 .

docker run --platform linux/amd64 via:v2.2 VIA --help
```
